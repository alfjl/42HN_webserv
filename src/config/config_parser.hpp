...
namespace webserv {
    namespace config {
		...
		protected:
			...
			void parse_listen();
			void parse_location(webserv::util::path anchor, webserv::pal::cpp::optional<bool>& server_autoindex, webserv::pal::cpp::optional<webserv::util::path> server_index_page);
